...
public class Legend extends Canvas {
    ...
    public void paint(Graphics legend) {             
        ...
        leg.drawString("Facility", 20, 285);  
        ...
        leg.drawString("Heard Rumor", 70, 195);
        leg.drawString("Rioting", 70, 225);
        
        //leg.drawString("Kibera", 70, 315);
        //leg.drawString("Surrounding Region", 70, 350);
        
        leg.drawString("Homes", 70, 315);
        leg.drawString("Facilities", 70, 350);
  
        //leg.drawString("Homes", 70, 445);
        //leg.drawString("Facilities", 70, 490);
